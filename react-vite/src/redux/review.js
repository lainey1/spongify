...
export const getReviewsByRestaurant = (restaurantId, reviews) => ({ type: GET_REVIEWS_BY_RESTAURANT, restaurantId, reviews });
export const getReviewsByUser = (userId, reviews) => ({ type: GET_REVIEWS_BY_USER, userId, reviews });
...
export const createNewReview = (reviewData, restaurant_id) => async (dispatch) => {
    try {
        const response = await fetch(`/api/reviews/restaurant/${restaurant_id}/review`, {
            method: 'POST',
